...
@main
struct SwiftLintAppPlugin: BuildToolPlugin {
        ...
        return [
            .buildCommand(
                ...
                arguments: [
                    ...
                    "--config",
                    "\(context.package.directory.string)/.swiftlint-app.yml",
                    "--cache-path",
...
extension SwiftLintAppPlugin: XcodeBuildToolPlugin {
        ...
        return [
            .buildCommand(
                ...
                arguments: [
                    ...
                    "--config",
                    "\(context.xcodeProject.directory.string)/.swiftlint-app.yml",
                    "--cache-path",
                    "\(context.pluginWorkDirectory.string)/cache"
                ],
                environment: [:]
