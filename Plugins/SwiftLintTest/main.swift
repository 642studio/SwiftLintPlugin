...
@main
struct SwiftLintTestPlugin: BuildToolPlugin {
        ...
        return [
            .buildCommand(
                ...
                arguments: [
                    ...
                    "--config",
                    "\(context.package.directory.string)/.swiftlint-test.yml",
                    "--cache-path",
...
extension SwiftLintTestPlugin: XcodeBuildToolPlugin {
        ...
        return [
            .buildCommand(
                ...
                arguments: [
                    ...
                    "--config",
                    "\(context.xcodeProject.directory.string)/.swiftlint-test.yml",
                    "--cache-path",
                    "\(context.pluginWorkDirectory.string)/cache"
                ],
                environment: [:]
